...
// ============================================================
// NAPLES AOB - CONSTRUCTION BLUEPRINT COORDINATION APP
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">BlueprintSync</h1>
          <p className="text-blue-300 mt-2">Naples AOB Construction Coordination</p>
        </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-6 text-white shadow-lg">
        ...
        <p className="text-blue-200 mt-1">Naples AOB — Airport Office Building Improvements</p>
